...
<tr>
    ...
    <td>
        <samp>
            <?=
            Boolean\Root::from(value: $group['several_products'])
                ->to_html();
            ?>
        </samp>
    </td>
...
<tr>
    ...
    <td>
        <samp>
            <?=
            Boolean\Root::from(value: $group['hide_choose_element'])
                ->to_html();
            ?>
        </samp>
    </td>
...
<tr>
    ...
    <td>
        <samp>
            <?=
            Boolean\Root::from(value: $group['no_selected_items_by_default'])
                ->to_html();
            ?>
        </samp>
    </td>
...
<tr class="JW_ACA--u-border--width-4">
    ...
    <td>
        <samp>
            <?=
            Boolean\Root::from(value: $group['sold_individually'])
                ->to_html();
            ?>
        </samp>
    </td>
