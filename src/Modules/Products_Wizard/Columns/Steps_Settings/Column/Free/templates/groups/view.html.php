...
<tr class="JW_ACA--u-border--width-4">
    ...
    <td>
        <samp>
            <?=
            Boolean\Root::from(value: $group['show_thumbnails'])
                ->to_html();
            ?>
        </samp>
    </td>
...
<tr>
    ...
    <td>
        <samp>
            <?=
            Boolean\Root::from(value: $group['enable_thumbnail_link'])
                ->to_html();
            ?>
        </samp>
    </td>
...
<tr>
    ...
    <td>
        <samp>
            <?=
            Boolean\Root::from(value: $group['merge_thumbnail_with_gallery'])
                ->to_html();
            ?>
        </samp>
    </td>
...
<tr class="JW_ACA--u-border--width-4">
    ...
    <td>
        <samp>
            <?=
            Boolean\Root::from(value: $group['show_galleries'])
                ->to_html();
            ?>
        </samp>
    </td>
...
<tr class="JW_ACA--u-border--width-4">
    ...
    <td>
        <samp>
            <?=
            Boolean\Root::from(value: $group['show_descriptions'])
                ->to_html();
            ?>
        </samp>
    </td>
...
<tr>
    ...
    <td>
        <samp>
            <?=
            Boolean\Root::from(value: $group['item_description_source'])
                ->to_html();
            ?>
        </samp>
    </td>
...
<tr class="JW_ACA--u-border--width-4">
    ...
    <td>
        <samp>
            <?=
            Boolean\Root::from(value: $group['enable_title_link'])
                ->to_html();
            ?>
        </samp>
    </td>
...
<tr>
    ...
    <td>
        <samp>
            <?=
            Boolean\Root::from(value: $group['show_attributes'])
                ->to_html();
            ?>
        </samp>
    </td>
...
<tr>
    ...
    <td>
        <samp>
            <?=
            Boolean\Root::from(value: $group['show_availabilities'])
                ->to_html();
            ?>
        </samp>
    </td>
...
<tr>
    ...
    <td>
        <samp>
            <?=
            Boolean\Root::from(value: $group['show_sku'])
                ->to_html();
            ?>
        </samp>
    </td>
...
<tr>
    ...
    <td>
        <samp>
            <?=
            Boolean\Root::from(value: $group['show_tags'])
                ->to_html();
            ?>
        </samp>
    </td>
...
<tr>
    ...
    <td>
        <samp>
            <?=
            Boolean\Root::from(value: $group['show_prices'])
                ->to_html();
            ?>
        </samp>
    </td>
