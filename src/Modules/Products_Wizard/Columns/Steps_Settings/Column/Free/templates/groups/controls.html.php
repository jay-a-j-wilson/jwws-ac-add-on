...
<tr>
    ...
    <td>
        <samp>
            <?=
            Boolean\Root::from(value: $group['buttons_nonblocking_requests'])
                ->to_html();
            ?>
        </samp>
    </td>
...
<tr class="JW_ACA--u-border--width-4">
    ...
    <td>
        <samp>
            <?=
            Boolean\Root::from(value: $group['enable_add_to_cart_button'])
                ->to_html();
            ?>
        </samp>
    </td>
...
<tr>
    ...
    <td>
        <samp>
            <?=
            Boolean\Root::from(value: $group['add_to_cart_behavior'])
                ->to_html();
            ?>
        </samp>
    </td>
