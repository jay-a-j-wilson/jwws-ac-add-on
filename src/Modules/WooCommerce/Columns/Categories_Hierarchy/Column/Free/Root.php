...
namespace JWWS\ACA\Modules\WooCommerce\Columns\Categories_Hierarchy\Column\Free;
...
class Root extends \AC\Column {
    ...
    public function __construct() {
        $this
            ...
            // Underscores allowed.
            ->set_type(type: 'column-categories_hierarchy')  
            ->set_group(group: 'woocommerce')
            // Default column label.
            ->set_label(label: __('Categories Hierarchy (Custom)', 'jwws'))
        ;
    }
