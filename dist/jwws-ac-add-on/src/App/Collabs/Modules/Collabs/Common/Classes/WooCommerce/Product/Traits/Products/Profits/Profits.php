...
namespace JWWS\ACA\App\Collabs\Modules\Collabs\Common\Classes\WooCommerce\Product\Traits\Products\Profits;
...
trait Profits {
    private function profit(): Profit {
        return Profit::of(
    ...
    public function profit_amount_with_sign(): string {
        return $this->profit_amount() === ''
            ? ''
            : wc_price(price: $this->profit_amount());
    }
