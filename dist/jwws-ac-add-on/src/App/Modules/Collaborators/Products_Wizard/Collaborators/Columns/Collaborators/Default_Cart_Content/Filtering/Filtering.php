...
namespace JWWS\ACA\App\Modules\Collaborators\Products_Wizard\Collaborators\Columns\Collaborators\Default_Cart_Content\Filtering;
...
final class Filtering extends Model {
    ...
    public function get_filtering_vars($vars) {
         ...
         * add_filter(
         *     'posts_where', array( $this, 'filter_by_custom_query' ), 10, 2
         * );
         */
